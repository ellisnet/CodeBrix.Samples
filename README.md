...
| `CodeBrix.Platform.ApacheLicenseForever` | 1.0.195.787 | The cross-platform XAML/UI framework and the Simple MVVM toolkit |
...
(1.0.195.787) — and the native heads add `CodeBrix.Platform.WinUI` / `CodeBrix.Platform.WPF`
...
`CodeBrix.Platform.Runtime.Skia.{Win32,Wpf,X11,Wayland,FrameBuffer,MacOS}.ApacheLicenseForever`
(1.0.195.787). The Windows-targeting Skia heads compile on Linux/macOS but only *run* on
...
| Package | Version | Role |
| --- | --- | --- |
| `CodeBrix.Platform.ApacheLicenseForever` | 1.0.195.787 | The cross-platform XAML/UI framework and the Simple MVVM toolkit (`SimpleViewModel`, `SimpleCommand`, `SimpleServiceResolver`) |
...
family as PainDiagram — `CodeBrix.Platform` (1.0.195.787), the six
