...
public class MainViewModel : SimpleViewModel
{
    ...
    /// ways of asking the same panel for its chain: Play composes it and hands it to the picture, Bake
    /// composes it and hands it to a file. Neither reads the other's result.
    /// </remarks>
    ...
    private void LoadCorpus()
    {
        ...
        CorpusText = $"{Videos.Count} videos and {Luts.Count} lookup tables from {assetsRoot}";
