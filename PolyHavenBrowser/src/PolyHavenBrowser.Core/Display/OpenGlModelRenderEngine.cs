...
/// </list>
/// This whole class is the swappable, API-specific layer: an engine for a different graphics
/// API would replace the context, the renderer, and the readback here while implementing the
/// same interface, and the painter/camera/loaders/UI above it would not change.
/// <para>
