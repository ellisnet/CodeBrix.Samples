...
/// <para>
/// This interface is the seam between the graphics API and the rest of the app. This
/// application uses one engine - <see cref="OpenGlModelRenderEngine"/> (OpenGL ES via EGL).
/// Everything <i>below</i> this seam is graphics-API-specific (GL contexts, shaders, pixel
/// readback); everything <i>above</i> it (models, camera, pointer input, Skia compositing)
/// is API-agnostic.
/// </para>
/// </summary>
