...
/// <summary>
/// Paints a <see cref="LoadedModel"/> onto the app's Skia canvas. This is the
/// <b>graphics-API-agnostic</b> half of the 3D preview: it
/// hands the actual drawing to an <see cref="IModelRenderEngine"/> (OpenGL, via EGL)
...
public sealed class ModelScenePainter : IScenePainter
{
    ...
    /// <summary>Creates a painter that renders through the given engine.</summary>
