...
namespace InannaRosette.Helpers;

/// <summary>
/// Small helpers shared by the heads' native "Save as…" and "Open…" dialogs.
/// </summary>
public static class FileDialogHelper
{
    ...
    /// percent-encoded, so a name with a space in it arrives as <c>My%20Reading.pdf</c> and
