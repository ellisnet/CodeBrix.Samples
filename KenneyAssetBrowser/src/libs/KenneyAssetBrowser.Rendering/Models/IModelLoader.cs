...
/// implementation is <see cref="GltfModelLoader"/> (Kenney 3D kits ship a GLB for every
/// model); the interface exists so the loading technology can be swapped or mocked
