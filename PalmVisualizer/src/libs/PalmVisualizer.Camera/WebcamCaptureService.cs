...
/// <summary>
/// The webcam capture model for PalmVisualizer: discovers connected cameras, runs a live
/// capture session on the selected one, and keeps the most recent BGRA frame available for
/// rendering (and for the palm-tracking pipeline). Audio is never captured, and no stills
