...
public sealed class ReliefEffect : BaseEffect
{
	...
	public override string Icon => Icons.EffectsStylizeRelief;

	public override string Name => Translations.GetString ("Relief");

	// Algorithm Code Ported From PDN
	public override void Render (Drawing.ImageSurface source, Drawing.ImageSurface destination, ReadOnlySpan<RectangleI> rois)
	{
