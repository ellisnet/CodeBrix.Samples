...
public class RectangleHandle : IToolHandle
{
	...
	public RectangleHandle (IWorkspaceService workspace)
	{
		...
		{
			{ HandlePoint.UpperLeft, new (workspace) { Cursor = ToolCursor.FromShape (StandardCursor.SizeNWSE) } },
			{ HandlePoint.LowerLeft, new (workspace) { Cursor = ToolCursor.FromShape (StandardCursor.SizeNESW) } },
			{ HandlePoint.UpperRight, new (workspace) { Cursor = ToolCursor.FromShape (StandardCursor.SizeNESW) } },
			{ HandlePoint.LowerRight, new (workspace) { Cursor = ToolCursor.FromShape (StandardCursor.SizeNWSE) } },
			{ HandlePoint.Left, new (workspace) { Cursor = ToolCursor.FromShape (StandardCursor.SizeWE) } },
			{ HandlePoint.Up, new (workspace) { Cursor = ToolCursor.FromShape (StandardCursor.SizeNS) } },
			{ HandlePoint.Right, new (workspace) { Cursor = ToolCursor.FromShape (StandardCursor.SizeWE) } },
			{ HandlePoint.Down, new (workspace) { Cursor = ToolCursor.FromShape (StandardCursor.SizeNS) } },
		};
	...
	/// </summary>
	public ToolCursor? GetCursorAtPoint (PointD viewPos)
