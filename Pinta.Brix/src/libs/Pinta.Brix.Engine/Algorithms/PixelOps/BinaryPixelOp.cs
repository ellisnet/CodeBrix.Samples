...
public abstract class BinaryPixelOp : PixelOp
{
	...
	public void Apply (Drawing.ImageSurface dst, PointI dstOffset,
			  Drawing.ImageSurface lhs, PointI lhsOffset,
			  Drawing.ImageSurface rhs, PointI rhsOffset,
			  Size roiSize)
	{
	...
	public void Apply (Drawing.ImageSurface dst, Drawing.ImageSurface src)
	{
	...
	public void Apply (Drawing.ImageSurface dst, Drawing.ImageSurface lhs, Drawing.ImageSurface rhs)
	{
