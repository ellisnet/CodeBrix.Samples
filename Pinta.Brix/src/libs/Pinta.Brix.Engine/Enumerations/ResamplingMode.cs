...
public static class ResamplingModeExtensions
{
	...
	/// </summary>
	public static Drawing.Filter ToCairoFilter (this ResamplingMode mode)
	{
		return mode switch {
			ResamplingMode.Bilinear => Drawing.Filter.Bilinear,
			ResamplingMode.NearestNeighbor => Drawing.Filter.Nearest,
			_ => throw new ArgumentOutOfRangeException (nameof (mode))
		};
	}
}
