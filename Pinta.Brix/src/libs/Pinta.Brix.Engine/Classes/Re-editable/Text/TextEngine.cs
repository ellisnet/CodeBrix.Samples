...
public sealed partial class TextEngine
{
	...
	public FontDescription Font { get; private set; } = FontDescription.New ();
	...
	public void SetFont (FontDescription font, TextAlignment alignment, bool underline)
	{
		Font = font;
		Alignment = alignment;
		Underline = underline;
	...
	public void PerformCopy (IClipboardService clipboard)
	{
	...
	public void PerformCut (IClipboardService clipboard)
	{
	...
	public async Task<bool> PerformPaste (IClipboardService clipboard)
	{
		string? txt;
		try {
			txt = await clipboard.GetTextAsync ();
		} catch (Exception) {
